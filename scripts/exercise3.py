...
def callback(x):
    if x.state == 1 or x.state == 2:
        rospy.loginfo(" I am in collution ")
...
def publisher():
    ...
    bumper_sub = rospy.Subscriber('/mobile_base/events/bumper', BumperEvent, callback)
    ...
    while not rospy.is_shutdown():
        ...
        for _ in range (10):
            ...
            desired_velocity.angular.z = 1.5708 # Rotating with 1.5 m/sec.
            pub.publish(desired_velocity)
            rate.sleep()
